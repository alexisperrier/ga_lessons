...
In other words we feed \\( \beta\_0 + \beta\_1 X \\) to the sigmoid function
...
- Z test: the regression coefficient divided by its standard error.coefficient is 0, the larger the better
