...
### Kaggle - titanic
Open a kaggle account and go through the Titanic tutorial. Excellent practice.
(don't despair it's the journey that counts)
</section>
...
<section  data-background-color="#FC9CB4">
    ...
    [http://bit.ly/1PghQGv](http://bit.ly/1PghQGv)
</section>
