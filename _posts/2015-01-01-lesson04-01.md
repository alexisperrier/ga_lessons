...
* Then X causes Y
* Then Y causes X
* Cannot say if one causes the other
...
see Notebook [Local](http://localhost:8888/notebooks/04_statistics_inference/py/Lesson%204%20-%20Notebook%201%20-%20Linear%20Regression.ipynb)
/ [Online](https://github.com/alexperrier/gads/blob/master/04_statistics_inference/py/Lesson%204%20-%20Notebook%201%20-%20Linear%20Regression.ipynb)
...
**Homoscedasticity**: for a given variable the low and high range have the same statistical properties
    Chunk data and Check Variance
...
Helps determine if the result is a fluke doue to sampling for instance or a real thing
sampling errors
</section>
